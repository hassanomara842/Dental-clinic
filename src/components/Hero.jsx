      ...
      <div className="container hero-container">
        <div className="hero-content">
          <div className="hero-badge" data-aos="fade-down" data-aos-delay="100">
            ...
            <span>رعايتك.. بابتسامة</span>
          </div>
          
          <h1 className="hero-title" data-aos="fade-up" data-aos-delay="200">
            ابتسامتك تستحق
            <br />
            <span className="text-primary">أفضل رعاية</span>
          </h1>
          
          <p className="hero-description" data-aos="fade-up" data-aos-delay="300">
            نقدم لك أحدث تقنيات طب الأسنان في بيئة مرحة
            <br />
            مع فريق متخصص يهتم براحتك وصحة أسنانك
          </p>
          
          <div className="hero-actions" data-aos="fade-up" data-aos-delay="400">
            <button className="btn btn-primary" onClick={() => window.dispatchEvent(new Event('open-booking-modal'))}>
              احجز موعدك الآن
              <Calendar size={18} />
            </button>
        ...
        <div className="hero-image-wrapper" data-aos="zoom-in" data-aos-delay="200">
          {/* We use a div to control the image styling and background */}
          <div className="hero-image-container">
             <img src="/assets/hero_dentist.png" alt="دكتور أسنان" className="hero-image" />
          </div>
        </div>
      </div>
    </section>
