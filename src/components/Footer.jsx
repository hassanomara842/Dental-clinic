      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <p className="slogan">رعايتك.. بابتسامة</p>
            <div className="social-icons">
              <a href="#" aria-label="Whatsapp">
                <div className="social-icon whatsapp-bg">
                   {/* Custom Whatsapp icon SVG since lucide doesn't have standard whatsapp but we can use MessageCircle or just hardcode */}
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              <li>
                <span className="fw-bold">السبت - الخميس</span>
                <span>10:00 ص - 2:00 م</span>
                <span>5:00 م - 10:00 م</span>
              </li>
              <li className="mt-2">
                <span className="fw-bold">الجمعة</span>
                <span>مغلق</span>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p>جميع الحقوق محفوظة © 2024 عيادة د.أحمد حسن</p>
        </div>
      </div>
    </footer>
  );
